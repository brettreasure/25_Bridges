...
//
// Drop this in as convex/schema.ts. Field names here are the contract the
// rest of the build spec (BUILD_SPEC.md) assumes — keep them in sync if
// you change anything.
...
export default defineSchema({
  ...
  people: defineTable({
    ...
    nameChin: v.optional(v.string()), // name as the student writes it in
    // Hakha Chin (Lai) — a plain Latin-script field, since Chin languages
    // use the Latin-based Hakha alphabet, not Myanmar/Burmese script.
